...
To install a source link, go to the app settings, then sources, and press the plus button in the top right and paste in the link.  
For trackers, simply do this in the trackers tab.  
